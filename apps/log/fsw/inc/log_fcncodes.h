...
#define LOG_ENABLED_CC             LOG_CCVAL(ENABLED)
#define LOG_DISABLED_CC            LOG_CCVAL(DISABLED)
#define LOG_GET_CURRENT_HEADER_CC  LOG_CCVAL(GET_CURRENT_HEADER)
#define LOG_GET_LOG_COUNT_CC       LOG_CCVAL(GET_LOG_COUNT)
#define LOG_QUERY_TIME_CC          LOG_CCVAL(QUERY_TIME)
#define LOG_QUERY_NUMBER_CC        LOG_CCVAL(QUERY_NUMBER)
