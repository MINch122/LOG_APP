...
#define DEFAULT_EVENT_MAKER_MISSION_CMD_TOPICID     0x93
#define EVENT_MAKER_MISSION_SEND_HK_TOPICID         EVENT_MAKER_MISSION_TIDVAL(SEND_HK)
#define DEFAULT_EVENT_MAKER_MISSION_SEND_HK_TOPICID 0x94
#define EVENT_MAKER_MISSION_HK_TLM_TOPICID          EVENT_MAKER_MISSION_TIDVAL(HK_TLM)
#define DEFAULT_EVENT_MAKER_MISSION_HK_TLM_TOPICID  0x95
