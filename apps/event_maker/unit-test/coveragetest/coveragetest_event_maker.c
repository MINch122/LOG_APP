...
void Test_EVENT_MAKER_Main(void)
{
    ...
    /*
     * EVENT_MAKER_Main does not return a value,
     ...
     * The first is for EVENT_MAKER_Init().  As this is in the same
     ...
     * the EVENT_MAKER_Init() failure path was taken.
     */
    EVENT_MAKER_Main();
     ...
     */
    UtAssert_UINT32_EQ(EVENT_MAKER_Data.RunStatus, CFE_ES_RunStatus_APP_ERROR);
    ...
    UT_CHECKEVENT_SETUP(&EventTest, EVENT_MAKER_PIPE_ERR_EID, "EVENT MAKER: SB Pipe Read Error, App Will Exit");
...
void Test_EVENT_MAKER_Init(void)
{
    /*
     * Test Case For:
    ...
    UtAssert_INT32_EQ(EVENT_MAKER_Init(), CFE_SUCCESS);
     ...
     */
    UT_SetDeferredRetcode(UT_KEY(CFE_EVS_Register), 1, CFE_EVS_INVALID_PARAMETER);
    UtAssert_INT32_EQ(EVENT_MAKER_Init(), CFE_EVS_INVALID_PARAMETER);
    UtAssert_STUB_COUNT(CFE_ES_WriteToSysLog, 1);

    UT_SetDeferredRetcode(UT_KEY(CFE_SB_CreatePipe), 1, CFE_SB_BAD_ARGUMENT);
    UtAssert_INT32_EQ(EVENT_MAKER_Init(), CFE_SB_BAD_ARGUMENT);
    ...
    UtAssert_INT32_EQ(EVENT_MAKER_Init(), CFE_TBL_ERR_INVALID_OPTIONS);
...
{
    ADD_TEST(EVENT_MAKER_Main);
    ADD_TEST(EVENT_MAKER_Init);
}
