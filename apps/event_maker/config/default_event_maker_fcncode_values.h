 ...
 */
#ifndef DEFAULT_EVENT_MAKER_FCNCODE_VALUES_H
#define DEFAULT_EVENT_MAKER_FCNCODE_VALUES_H

/************************************************************************
 * Macro Definitions
 ************************************************************************/

#define EVENT_MAKER_CCVAL(x) EVENT_MAKER_FunctionCode_##x

enum EVENT_MAKER_FunctionCode_
{
