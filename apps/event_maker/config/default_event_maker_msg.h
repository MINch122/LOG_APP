 ...
 *   message data types.
 *
 * This is a compatibility header for the "event_maker_msg.h" file that has
 ...
 * dictionary tool.
 */
#ifndef DEFAULT_EVENT_MAKER_MSG_H
#define DEFAULT_EVENT_MAKER_MSG_H

#include "event_maker_mission_cfg.h"
#include "event_maker_msgdefs.h"
#include "event_maker_msgstruct.h"
